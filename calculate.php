        ...
        <section class="page-section" id="services">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Cotizacion de Servicios</h2>
                    <h3 class="section-subheading text-muted">Cotizacion rapida de servicios.</h3>
                </div>
                <div class="row">
                    <div class="col-md-12">
            ...
            <form action="validarCotizacion.php" method="post">
            <select name="cars" id="cars">
    <option value="d1">Desarrollo a la medida</option>
    <option value="d2">Soporte tecnico</option>
    <option value="d3">Base de datos</option>
  </select>
<br>
<br>

<p>Nombre de proyecto: <input type="text" name="name" /></p>
 <p>Tiempo para el proyecto: <input type="text" name="time" /> dias laborales</p>
 <p>Personas: <input type="text" name="persons" /></p>
